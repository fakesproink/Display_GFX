Blockly.Blocks["oled_gfx.clear"] = {
	...
	this.setColour(160);
	this.setTooltip(Blockly.Msg.OLED_GFX_CLEAR_TOOLTIP);
	this.setHelpUrl("");
}};
...
Blockly.Blocks["oled_gfx.print"] = {
	...
	this.setNextStatement(true);
	this.setColour(160);
	this.setTooltip(Blockly.Msg.OLED_GFX_PRINT_TOOLTIP);
	this.setHelpUrl("");
}};
...
Blockly.Blocks["oled_gfx.printGFX"] = {
	...
	this.setNextStatement(true);
	this.setColour(160);
	this.setTooltip(Blockly.Msg.OLED_GFX_PRINTGFX_TOOLTIP);
	this.setHelpUrl("");
}};
...
Blockly.Blocks['oled_gfx.num2str'] = {
	init: function() {
		...
		this.setColour(160);
		this.setTooltip(Blockly.Msg.OLED_GFX_NUM2STR_TOOLTIP);
		this.setHelpUrl("");
}};
